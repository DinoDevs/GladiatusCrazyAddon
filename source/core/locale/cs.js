...
gca_languages['cs'] = {
	...
	locale : {
		...
		settings : {
			...
			category_market$custom_prices : "Vlastní nastavitelné ceny tržiště, rozděleny čárkou. Cenu položky lze také vypočítat procentuálně přidáním '%' za číslo. (např., '10000, 10.000, 00%')",
