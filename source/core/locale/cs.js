...
gca_languages['cs'] = {
	...
	locale : {
		...
		settings : {
			...
			category_global$bar_hide_exp_btn : "Skrýt tlačítko expedice",
			category_global$bar_hide_dun_btn : "Skrýt tlačítko bludiště",
			category_global$bar_hide_are_btn : "Skrýt tlačítko arény",
			category_global$bar_hide_ct_btn : "Skrýt tlačítko Circus Turma",
			// Settings - Overview
