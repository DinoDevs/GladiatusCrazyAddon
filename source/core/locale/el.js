...
gca_languages["gr"] = {
	...
	"locale": {
		...
		"global": {
			...
			"message_sent_success": "Το μήνυμα τάγματος στάλθηκε",
			"message_sent_failed": "Η αποστολή του μηνύματος τάγματος απέτυχε",
			"message_empty": "Το μήνυμα τάγματος είναι κενό",
			...
			"gold_exp_data_today": "Σημερινές τιμές",
			"gold_exp_data_week": "Τιμές 7 ημερών",
