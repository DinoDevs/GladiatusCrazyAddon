...
gca_languages["en"] = {
	...
	locale : {
		...
		training : {
			...
			points_breakdown_block_max : "Block: MAX",
			points_breakdown_normal_hit : "Hit: +{{integer}}% (+{{float}}‰) *",
			points_breakdown_critical_hit : "Crit hit: +{{integer}}% (+{{float}}‰)",
			points_breakdown_double_hit : "Double hit: +{{integer}}% (+{{float}}‰) *",
			points_breakdown_avoid : "Avoid crit: +{{integer}}% (+{{float}}‰)",
			points_breakdown_avoid_max : "Avoid crit: MAX",
			points_breakdown_enemy_normal_hit : "Enemy hit: {{integer}}% ({{float}}‰) *",
			points_breakdown_enemy_double_hit : "Enemy 2hit: {{integer}}% ({{float}}‰) *",
			points_breakdown_life : "Life: +{{number}}",
			points_breakdown_regeneration : "Regeneration: +{{number}}",
			points_breakdown_threat : "Threat: +{{integer}} (+{{float}})",
			points_breakdown_heal : "Heal: +{{integer}} (+{{float}})",
			points_breakdown_critical_heal : "Crit heal: +{{integer}}% (+{{float}}‰)",
			points_breakdown_critical_heal_max : "Crit heal: MAX",
