...
gca_languages["en"] = {
	...
	locale : {
		...
		settings : {
			...
			category_global$bar_hide_exp_btn : "Hide the Expedition button",
			category_global$bar_hide_dun_btn : "Hide the Dungeon button",
			category_global$bar_hide_are_btn : "Hide the Arena button",
			category_global$bar_hide_ct_btn : "Hide the Circus Turma button",			
			// Settings - Overview
