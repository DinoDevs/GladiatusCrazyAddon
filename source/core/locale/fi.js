...
gca_languages["fi"] = {
	...
	locale : {
		...
		settings : {
			...
			category_global$advance_main_menu : "Näytä päävalikon lisäpikavalinnat",
			category_global$submenu_click_to_change : "Vaadi klikkaus alavalikkojen avaamiseksi (testaa vasen päävalikko)",
			...
			category_global$quest_timer : "Näytä tehtävien odotusaika",
			category_global$merchants_timer : "Näytä seppien odotusajat (vihreä/punainen pallo sepälistan vasemmalla puolella)",
			category_global$forge_timers : "Näytä ilmoitus takomon/sulaton valmistumisista. Näytä sulaton/takomon odotusajat (vihreä/punainen pallo takomon vasemmalla puolella)",
			...
			category_global$centurio_powerups_timers : "Näytä centurio/siunaus ajat Premium napin yhteydessä (hiiri päälle)",
