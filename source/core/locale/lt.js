...
gca_languages['lt'] = {
	...
	locale : {
		...
		settings : {
			...
			category_global$advance_main_menu : "Pagerinti pagrindinį meniu",
			category_global$submenu_click_to_change : "Submeniu pakeitimas paspaudus pelės mygtuką",
			category_global$remember_tabs : "Atsiminti skyrius pas pirklius",
			category_global$attacked_timers : "Rodyti atakų laikus",
			category_global$quest_timer : "Rodyti užduoties būseną arba laiką",
			category_global$merchants_timer : "Rodyti pirklių laiką",
			category_global$forge_timers : "Rodyti kalimo/lydimo laiką",
			category_global$cooldown_sound_notifications : "Įjungti (ekspedicijų, požemių, arenų) atsistatymo garsinius įspėjimus",
