...
gca_languages["tr"] = {
	...
	locale : {
		...
		settings : {
			...
			category_global$hp_timer_for_full_life : "Yaşam enerjinisin dolacağı zamanı göster",
			//category_global$expedition_dungeon_points_recover_timer : "...",
			//category_global$expedition_timer_for_full_expedition : "Keşif seferlerinin dolacağı zamanı göster",
			//category_global$dungeon_timer_for_full_dungeon : "Zindanın dolacağı zamanı göster",
