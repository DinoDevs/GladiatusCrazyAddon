...
gca_languages['de'] = {
	...
	locale : {
		...
		display_my_stats : "Meine Statistiken anzeigen",
		...
		use_life_potion : "Einen 100% Heiltrank benutzen",
		...
		friendly : "Freundlich",
		show_raided_gold : "Zeige das erbeutete Gold",
		...
		enable_multiplier : "Multiplikator aktivieren",
		search_for_players : "Nach Spielern suchen",
		guild_status : "Gildenstatistiken",
		in_guild : "In einer Gilde",
		no_guild : "Ohne Gilde",
		search : "Suche",
		...
		packages_expiring_in : "Die Pakete verfallen in",
		hours : "Stunde(n)",
		error : "Fehler",
		loading : "Läd",
		clear : "löschen",
		...
		OPTIONS_GLOBAL_AUCTION_STATUS_NOTIFICATION : "Benachrichtigen wenn sich der Status der Auktion ändert",
		...
		OPTIONS_GLOBAL_QUESTS_TIMER : "Zeige den Questgeber/Zeit",
		...
		OPTIONS_AUCTION_MULTIPLE_BIDS : "Aktiviere Mehrfachgebote (kein Seitenreload)",
		OPTIONS_AUCTION_WARN_GUILD : "Aktiviere den Button zum Melden des Auktionsstatus an die Gilde",
		...
		OPTIONS_AUCTION_TOOLTIP_MODIFICATIONS : "Aktiviere Tooltip Modifikationen",
		...
		OPTIONS_MARKET_DEFAULT_SELL_DURATION : "Wähle die Standardzeit aus, wie lange ein Item in den Markt gestellt werden soll",
		...
		OPTIONS_MERCHANTS_HIGHLIGHT_ITEMS : "Aktiviere die Markierung bei Items die du für die Söldner kaufen kannst",
		OPTIONS_MERCHANTS_INFOS : "Aktiviere die Informationsbox unterhalb der Söldner",
		...
		OPTIONS_MESSAGES_CONVERT_LINKS : "Konvertiere Text URLs zu Links",
		OPTIONS_MESSAGES_FIX_SPACES : "Fix des Nachrichtenplatz Problems",
		OPTIONS_NEW_MESSAGE_OPTIONS : "Neue Nachrichten Einstellungen",
		OPTIONS_NEWMESSAGE_FOCUS : "Automatisch den Curser in den Content setzen",
		...
		OPTIONS_PACKAGES_EXPIRED_PACKAGES : "Aktiviere die \"Paket(e) verfallen\" Warnung",
		...
		OPTIONS_GUILD_MESSAGE_INTERFACE : "Gildennachricht Ansicht verbessern",
		OPTIONS_GUILD_JAIL_INTERFACE : "Gefängnis Ansicht verbessern",
		OPTIONS_GUILD_LIBRARY_INTERFACE : "Bibliothek Ansicht verbessern",
		OPTIONS_GUILD_BANK_INTERFACE : "Bank Ansicht verbessern",
		OPTIONS_GUILD_APPLICATION_ALERT : "Benachrichtigung bei einer neuen Gildenbewerbung (Gilden Admin)",
		OPTIONS_PANTHEON_OPTIONS : "Pantheon Einstellungen",
		OPTIONS_ARENA_OPTIONS : "Arena Einstellungen",
		OPTIONS_ARENA_SERVER_ARENA_ORDER : "Gladiatoren nach Level sortieren",
		OPTIONS_PLAYER_OPTIONS : "Spielerübersicht Einstellungen",
		OPTIONS_PLAYER_SIMULATOR_BUTTON : "Simulator Button aktivieren",
		OPTIONS_PREMIUM_OPTIONS : "GCA Premium Einstellung",
		OPTIONS_PREMIUM_KEY : "GCA Premium Key eintragen",
